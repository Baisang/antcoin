...
uint256 hashGenesisBlock("0x908ce9659ba0219008012712f47e2efe81fb408d72299198439c852035281fad");
...
static const int64 nTargetTimespan = 0.04 * 24 * 60 * 60; // AntCoin: 1 hour?
static const int64 nTargetSpacing = 10; // AntCoin: 10 seconds blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x908ce9659ba0219008012712f47e2efe81fb408d72299198439c852035281fad");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1394573588;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085468988;

        if (fTestNet)
        {
            block.nTime    = 1393453366;
            block.nNonce   = 387995902;
        }
